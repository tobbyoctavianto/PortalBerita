<?php
	...
	function tgl_ina2($parameter1){ //ini untuk mengubah format 2015-06-15 17:00:00 ke dalam
						//	format 15/06/2015 >> 17:00:))
		$parameter2=substr($parameter1,0,10); //10 digit dari kiri,ini untuk peroleh nilai 2015-06-15 dari
							//	nilai 2015-06-15 17:00:00
		$parameter3=substr($parameter1,-8); //10 digit dari kanan,ini untuk peroleh 17:00:00 dari nilai 2015-06-15 17:00:00

		$thn=substr($parameter2,2,2); //menngambil 2 digit dari kiri, 2 adalah index ketiga dari tahun
									// (angka 1 dari 2015), 2 banyaknya digit yg diambil
	...
	function jangkawaktu($waktu1,$waktu2){
		...
		return $jangkawaktu;						//tapi jangka waktu, dari tgl 11 sampai 13 adalah 3 hari.
										//bukan 13-11= 2 har
	}
